...
fun SimArea(day: Day) {
  ...
  Canvas(
    ...
    day.roomLocations.forEach { room ->
      drawCircle(center = room.location.toOffset(), radius = 10f, color = Color.Blue)
      // drawIntoCanvas {
      //   drawText(
      //     "Test",
      //     10f,
...
private fun Vector.toOffset(): Offset {
